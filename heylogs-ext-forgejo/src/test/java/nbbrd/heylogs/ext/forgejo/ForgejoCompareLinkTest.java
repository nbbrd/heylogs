...
class ForgejoCompareLinkTest {
    ...
    public void testCompliance() {
        assertForgeLinkCompliance(parse("https://codeberg.org/Freeyourgadget/Gadgetbridge/compare/0.86.0...0.86.1"));
    }
    ...
    public void testRepresentableAsString() {
        assertThatIllegalArgumentException()
                ...
                .isThrownBy(() -> parse("https://codeberg.org/Freeyourgadget/Gadgetbridge/compare"))
                .withMessage("Invalid path length: expecting [4], found 3");

        assertThatIllegalArgumentException()
                .describedAs("invalid OID")
                .isThrownBy(() -> parse("https://codeberg.org/Freeyourgadget/Gadgetbridge/compare/0.86.0..."))
                .withMessage("Invalid path item at index 3: expecting pattern '.+\\.{3}.+', found '0.86.0...'");

        assertThatIllegalArgumentException()
                .describedAs("missing compare")
                .isThrownBy(() -> parse("https://codeberg.org/Freeyourgadget/Gadgetbridge/0.86.0...0.86.1"))
                .withMessage("Invalid path length: expecting [4], found 3");

        assertThatIllegalArgumentException()
                .describedAs("invalid compare")
                .isThrownBy(() -> parse("https://codeberg.org/Freeyourgadget/Gadgetbridge/compar/0.86.0...0.86.1"))
                .withMessage("Invalid path item: expecting [compare], found 'compar'");

        assertThatIllegalArgumentException()
                .describedAs("missing repo")
                .isThrownBy(() -> parse("https://codeberg.org/Freeyourgadget/compare/0.86.0...0.86.1"))
                .withMessage("Invalid path length: expecting [4], found 3");

        assertThatIllegalArgumentException()
                .describedAs("invalid repo")
                .isThrownBy(() -> parse("https://codeberg.org/Freeyourgadget/hey%20logs/compare/0.86.0...0.86.1"))
                .withMessage("Invalid path item at index 1: expecting pattern '[a-z\\d._-]{1,100}', found 'hey logs'");

        assertThatIllegalArgumentException()
                .describedAs("missing owner")
                .isThrownBy(() -> parse("https://codeberg.org/Gadgetbridge/compare/0.86.0...0.86.1"))
                .withMessage("Invalid path length: expecting [4], found 3");

        assertThatIllegalArgumentException()
                .describedAs("invalid owner")
                .isThrownBy(() -> parse("https://codeberg.org/nbb%20rd/Gadgetbridge/compare/0.86.0...0.86.1"))
                .withMessage("Invalid path item at index 0: expecting pattern '[a-z\\d](?:[a-z\\d]|-(?=[a-z\\d])){0,38}', found 'nbb rd'");

        assertThat(parse("https://codeberg.org/Freeyourgadget/Gadgetbridge/compare/0.86.0...0.86.1"))
                ...
                .returns("0.86.0...0.86.1", ForgejoCompareLink::getOid)
        ...
        assertThat(parse("https://localhost:8080/Freeyourgadget/Gadgetbridge/compare/0.86.0...0.86.1"))
