...
class ForgejoIssueLinkTest {
    ...
    public void testCompliance() {
        assertForgeLinkCompliance(parse(urlOf("https://codeberg.org/Freeyourgadget/Gadgetbridge/issues/5173")));
    }
    ...
    public void testRepresentable() {
        assertThatIllegalArgumentException()
                ...
                .isThrownBy(() -> parse(urlOf("https://codeberg.org/Gadgetbridge/issues/5173")))
                .withMessage("Invalid path length: expecting [4], found 3");

        assertThatIllegalArgumentException()
                .describedAs("invalid owner")
                .isThrownBy(() -> parse(urlOf("https://codeberg.org/nbb%20rd/Gadgetbridge/issues/173")))
                .withMessage("Invalid path item at index 0: expecting pattern '[a-z\\d](?:[a-z\\d]|-(?=[a-z\\d])){0,38}', found 'nbb rd'");

        assertThatIllegalArgumentException()
                .describedAs("missing repo")
                .isThrownBy(() -> parse(urlOf("https://codeberg.org/Freeyourgadget/issues/173")))
                .withMessage("Invalid path length: expecting [4], found 3");

        assertThatIllegalArgumentException()
                .describedAs("invalid repo")
                .isThrownBy(() -> parse(urlOf("https://codeberg.org/Freeyourgadget/hey%20logs/issues/173")))
                .withMessage("Invalid path item at index 1: expecting pattern '[a-z\\d._-]{1,100}', found 'hey logs'");

        assertThatIllegalArgumentException()
                .describedAs("missing type")
                .isThrownBy(() -> parse(urlOf("https://codeberg.org/Freeyourgadget/Gadgetbridge/173")))
                .withMessage("Invalid path length: expecting [4], found 3");
        ...
        assertThatIllegalArgumentException()
                ...
                .isThrownBy(() -> parse(urlOf("https://codeberg.org/Freeyourgadget/Gadgetbridge/issues")))
                .withMessage("Invalid path length: expecting [4], found 3");
        ...
        assertThat(parse(urlOf("https://localhost:8080/Freeyourgadget/Gadgetbridge/issues/173")))
    ...
    void testResolve() {
        ...
        assertThat(ForgejoIssueLink.resolve(urlOf("https://codeberg.org/Freeyourgadget/Gadgetbridge"), "#173"))
                .returns(urlOf("https://codeberg.org"), ForgejoIssueLink::getBase)
                .returns("Freeyourgadget", ForgejoIssueLink::getOwner)
                .returns("Gadgetbridge", ForgejoIssueLink::getRepo)
                .returns(173, ForgejoIssueLink::getIssueNumber)
                .hasToString("https://codeberg.org/Freeyourgadget/Gadgetbridge/issues/173");
        ...
        assertThat(ForgejoIssueLink.resolve(urlOf("https://codeberg.org/otherowner/otherrepo"), "Freeyourgadget/Gadgetbridge#173"))
                .returns(urlOf("https://codeberg.org"), ForgejoIssueLink::getBase)
                .returns("otherowner", ForgejoIssueLink::getOwner)
                .returns("otherrepo", ForgejoIssueLink::getRepo)
                .returns(173, ForgejoIssueLink::getIssueNumber)
                .hasToString("https://codeberg.org/otherowner/otherrepo/issues/173");
