...
class GitHubIssueLinkTest {
    ...
    public void testCompliance() {
        assertForgeLinkCompliance(parse(urlOf("https://github.com/nbbrd/heylogs/issues/173")));
    }
    ...
    public void testRepresentable() {
        ...
        assertThatIllegalArgumentException()
                ...
                .isThrownBy(() -> parse(urlOf("https://github.com/nbbrd/heylogs/issues")))
                .withMessage("Invalid path length: expecting [4], found 3");
        ...
        assertThat(parse(urlOf("https://localhost:8080/nbbrd/heylogs/issues/173")))
