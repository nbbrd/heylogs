...
public class LinkRulesTest {
    ...
    public void testCompliance() {
        assertRuleCompliance(new LinkRules.Batch());
    }

    @Test
    public void test() {
        Node sample = using("/Main.md");
        for (LinkRules rule : LinkRules.values()) {
    ...
    public void testValidateHttps() {
        ...
        assertThat(Nodes.of(LinkNodeBase.class).descendants(using("/NonHttps.md")))
                ...
                .isNotEmpty()
                .filteredOn(Objects::nonNull)
                .contains(RuleIssue.builder().message("Expecting HTTPS protocol").line(1).column(1).build(), org.assertj.core.data.Index.atIndex(0))
                .contains(RuleIssue.builder().message("Expecting HTTPS protocol").line(2).column(7).build(), org.assertj.core.data.Index.atIndex(1))
                .contains(RuleIssue.builder().message("Expecting HTTPS protocol").line(6).column(1).build(), org.assertj.core.data.Index.atIndex(2))
                .hasSize(3);
    }
    ...
    public void testValidateForgeRef() {
        ...
        assertThat(validateForgeRef(asLink("[stuff](https://issue)"), RuleContext.builder().forge(forge.toBuilder().linkParser(ISSUE, url -> tests.heylogs.spi.MockedForgeLink.of(url, null)).build()).build()))
                .describedAs("No ref parser")
                .isEqualTo(NO_RULE_ISSUE);

        assertThat(validateForgeRef(asLink("[stuff](https://issue)"), RuleContext.builder().forge(forge.toBuilder().linkParser(ISSUE, url -> tests.heylogs.spi.MockedForgeLink.of(url, null)).refParser(ISSUE, ref -> tests.heylogs.spi.MockedForgeRef.of(true)).build()).build()))
                .describedAs("Compatible ref")
                .isEqualTo(NO_RULE_ISSUE);

        assertThat(validateForgeRef(asLink("[stuff](https://issue)"), RuleContext.builder().forge(forge.toBuilder().linkParser(ISSUE, url -> tests.heylogs.spi.MockedForgeLink.of(url, null)).refParser(ISSUE, ref -> null).build()).build()))
                .describedAs("No expected ref")
                .isEqualTo(NO_RULE_ISSUE);

        assertThat(validateForgeRef(asLink("[stuff](https://issue)"), RuleContext.builder().forge(forge.toBuilder().linkParser(ISSUE, url -> tests.heylogs.spi.MockedForgeLink.of(url, tests.heylogs.spi.MockedForgeRef.of(true))).refParser(ISSUE, ref -> null).build()).build()))
        ...
        assertThat(validateForgeRef(asLink("[stuff](https://issue)"), RuleContext.builder().forge(forge.toBuilder().linkParser(ISSUE, url -> tests.heylogs.spi.MockedForgeLink.of(url, tests.heylogs.spi.MockedForgeRef.of(true))).refParser(ISSUE, ref -> tests.heylogs.spi.MockedForgeRef.of(false)).build()).build()))
    ...
    public void testValidateTagVersioning() {
        RuleContext baseContext = RuleContext
                ...
                .forge(ForgeSupport
                        ...
                        .linkParser(ISSUE, tests.heylogs.spi.MockedForgeLink::parse)
                        .linkParser(ForgeLinkType.COMPARE, tests.heylogs.spi.MockedCompareLink::parse)
                        .build())
    ...
    public void testValidateNoOrphanRef() {
        ...
        RuleContext withForge = RuleContext
                ...
                .forge(ForgeSupport
                        ...
                        .id("mocked").name("").moduleId("")
                        .knownHostPredicate(url -> true)
                        .refParser(ISSUE, text -> text.toString().startsWith("#") ? tests.heylogs.spi.MockedForgeRef.of(true) : null)
                        .build())
                .build();
