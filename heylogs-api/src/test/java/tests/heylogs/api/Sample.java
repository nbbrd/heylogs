...
public class Sample {
    ...
    public static final Resource RESOURCE1 = Resource.builder().type("a").module("stuff").id("hello").name("(A) Hello").build();
    public static final Resource RESOURCE2 = Resource.builder().type("world").module("stuff").id("b").name("World (B)").build();
