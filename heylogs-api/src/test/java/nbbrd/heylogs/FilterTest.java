...
public class FilterTest {
    ...
    private final Version unreleased = Version.of("Unreleased", null, HYPHEN, LocalDate.MAX, false);
    private final Version v1_1_0 = Version.of("1.1.0", null, HYPHEN, LocalDate.parse("2019-02-15"), false);
    private final Version v1_0_0 = Version.of("1.0.0", null, HYPHEN, LocalDate.parse("2017-06-20"), false);
}
